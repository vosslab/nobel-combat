...
| M14 McClintock end-to-end fighter | Complete; face re-review open | Promoted the sealed rich-v4 `female_9` donor unchanged (SHA-256 `6dbf479fa42e78d1890539a19dfd70953e545cd8894ea6efe4e8dafaad720d07`) after a readiness-bound ordinary-gameplay comparison. Existing two-slot sixteen-state evidence binds the same bytes; the refreshed runtime portrait is receipt-bound. The earlier gameplay-caricature review accepted her feminine face, dark hair, wire glasses, and light coat; the 2026-09-26 face-only texture trial did not separate the face on the roster sheet, so re-review remains open ([report](../reports/portrait_texture_experiment.md)). The generated-head graft remains an unregistered experiment. |
...
| M22 Wave 1 models                 | Complete; face re-review open | Hodgkin's Curie-donor v2, Goodenough V9, and Buck's simple-donor v2 are accepted under the gameplay-caricature standard.                                                                                                                                                                                                                                                                                                                                                               |
| M23 Wave 1 fighters               | Complete; face re-review open | Hodgkin, Goodenough, and Buck are playable starters with their accepted bodies, portraits, specials, AI, and unlocks. The controlled eight-fighter G2 passed 39/39; its report is `tests/_temp/eight_fighter_g2_controlled_final/report.md`.                                                                                                                                                                                                                                           |
| M24 Wave 2 models                 | Complete; face re-review open | Doudna, Tsien, Strickland, Bertozzi, and Levi-Montalcini have registered bodies under the earlier gameplay-caricature gate. The 2026-09-26 audit reopens roster-level face identity; no prior face pass is grandfathered. Tsien's and Strickland's glasses fits remain accepted on unchanged bodies.                                                                                                                                                                                                 |
| M25 Wave 2 fighters               | In progress | Doudna is playable through `winAs McClintock`, Tsien through `winAs Hodgkin`, Strickland through `winAs Goodenough`, Bertozzi through `winAs Curie`, and Levi-Montalcini through `winAs Buck`; the wave awaits independent integration review and its full-wave G2 gate. Apply the new face-distinction criterion to new candidates; resolve existing face duplicates before M33 closeout. See the [portrait texture and roster identity report](../reports/portrait_texture_experiment.md). |
| M26 Wave 3 models                 | In progress | Steitz's donor and stock MPFB2 lines are retired; Anfinsen's Goodenough, sparse-morph/PCA-fit, neutral bitmap-head, and male_32 scalp-cue proofs are retired; Baker's procedural and male_10 lines are retired; Frank V11's plain head is primitive, while Blackburn V12 failed its paused face gate and needs a fresh detailed source. New candidates must pass the revised face-level roster comparison.                                                                                         |
| M27 Wave 3 fighters               | Queued      | Each fighter may integrate when its own candidate passes the revised face-level roster comparison and its direct unlock prerequisites are ready                                                                                                                                                                                                                                                                                                                                        |
...
| M29 Wave 4 fighters               | Queued      | Each fighter may integrate when its own candidate passes the revised face-level roster comparison and its direct unlock prerequisites are ready                                                                                                                                                                                                                                                                                                                                        |
| M30 Wave 5 models                 | In progress | Bardeen V2, Sharpless V3, and Herzberg V9 fail the face/rich-body gate; Gabor V18's plain head and the male_32 mustache candidate fail visual review, and the bounded detailed-head survey is a no-go. New candidates must pass the revised face-level roster comparison.                                                                                                                                                                                                                   |
| M31 Wave 5 fighters               | Queued      | Each fighter may integrate when its own candidate passes the revised face-level roster comparison and its direct unlock prerequisites are ready                                                                                                                                                                                                                                                                                                                                        |
...
The registry currently has twelve playable fighters. A same-scale 2026-09-26 contact-sheet review
found that Franklin, Buck, and Bertozzi read as the same face when hair, glasses, clothing, and
silhouette are set aside. An exact-byte census also found five repeated face-image groups among the
twelve models; Franklin, Buck, McClintock, Doudna, and Bertozzi share one identical embedded atlas.
The [portrait-texture report](../reports/portrait_texture_experiment.md) records the census and two
bounded portrait-to-atlas attempts plus one hand-painted face edit; all three are rejected on
appearance. The prior appearances remain integrated but are not grandfathered through the revised
face gate: resolve the existing duplicate-face groups before M33 closeout. Remaining model reviews
require a face-level roster comparison; fighter integration continues when each new candidate passes
its updated gate and unlock prerequisites.
...
integrations, alongside Warburg, Curie, Franklin, and McClintock, for twelve fighters in the current
registry.
...
| M26 Baker           | fresh face-approved source needed                   | The `male_10` source is retired: its hair texture shares atlas components with face, eyes, nose, mouth, and beard, so a local hair fix would damage the face. A different donor alone cannot satisfy the revised face gate. [Handoff](../workstreams/roster_candidate_m26_baker.md)                                                                                                                                                               |
...
| M26 Anfinsen        | male_32 cue v2 retired                              | The same-scale 13-face review shows the unchanged donor face is visibly older and more severe than Anfinsen's 1969 portrait; the added gray scalp pieces read as patches. Donor selection and scalp geometry do not establish face identity. No male_32 retry or integration. [Handoff](../workstreams/roster_candidate_m26_anfinsen.md)                                                                                                |
...
| M30 Gabor           | `male_32` v1 retired                               | The compact gray cue floats away from the upper lip, and the unchanged face duplicates the retired Anfinsen `male_32` donor. No 16-state appearance review, glasses fitting, or FighterDef follows. [Handoff](../workstreams/roster_candidate_m30_gabor.md)                                                                                                                                                                           |
