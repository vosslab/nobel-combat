...
# Exclude non-pytest test tiers and disposable authoring evidence from pytest
# collection. Browser and end-to-end runners execute explicitly; _temp is not
# a permanent test lane.
collect_ignore = ["_temp", "e2e", "playwright"]
...
#
# Roster candidate scripts are retained provenance for asset authoring, not
# maintained application Python, so hygiene linters do not treat them as such.
