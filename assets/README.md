...
The Warburg and Franklin models and the animation libraries come from
...
Marie Curie's period-dress model is the [Old Lady asset by CDmir on
...
`models/curie_period.glb` keeps the authored model,
hair, dress, and rig with a packed texture. Babylon.js retargets the existing
local Mesh2Motion clips through the explicit Curie-only bone map in
`src/rigged_fighter.ts`. The original source digest is recorded, but the GLB
export tool version and settings were not preserved, so the conversion process
...
| `models/curie_period.glb`                | OpenGameArt `oldlady-v2.blend`, converted to GLB                    | `2a76aa3fa75990e83dbb7d68f64e2d67dec4eda394a9bc925f20f2f1d74e1ed4` | Marie Curie's period-dress presentation rig                   |
...
| `models/mesh2motion_female_31.glb`       | `static/models-variation/human/female_31.glb`                       | `72c50339c0caa248b19ec11a5c188d52f6e2bf8e16bd0dd64e98ae756680ceb3` | Retired Franklin candidate; not loaded or built               |
